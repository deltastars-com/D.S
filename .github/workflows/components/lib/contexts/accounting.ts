...
export const mockVipClients: VipClient[] = [
    { id: '966558828009', phone: '966558828009', companyName: 'فندق دلتا التجريبي', contactPerson: 'مدير المشتريات', shippingAddress: 'شارع المنار، جدة، المملكة العربية السعودية', creditLimit: 10000, currentBalance: 0, clientStatus: 'active' },
    { id: '966501234567', phone: '966501234567', companyName: 'مطاعم الواحة', contactPerson: 'الشيف التنفيذي', shippingAddress: 'طريق الملك عبدالعزيز، حي الزهراء، جدة', creditLimit: 5000, currentBalance: -363.08, clientStatus: 'active' },
    { id: '966598765432', phone: '966598765432', companyName: 'سوبرماركت النجمة', contactPerson: 'مسؤول قسم الخضار', shippingAddress: 'شارع الأمير سلطان، حي السلامة، جدة', creditLimit: 15000, currentBalance: 0, clientStatus: 'standard' },
];
